...
$3$ fois la réponse utilise~\iocaml{List.rev};
$3$ fois la réponse s'appuie sur~\iocaml{List.fold_left} ;
$2$ fois la réponse s'appuie sur~\iocaml{List.fold_right} ;
$1$ : la réponse utilise un \iocaml{if-then-else} au lieu du filtrage par motifs.
