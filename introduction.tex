...
constitue une grande quantité d'information difficilement exploitable
directement, en tout cas pour nos cas d'usage. En particulier, cette
mesure n'étant pas une distance, elle ne fournit pas d'emblée une
structure hiérarchique sur laquelle s'appuyer pour synthétiser des
indicateurs généraux \am{En quoi une distance offre ces indicateurs
?}.
}
%
Pour
