...
au nombre de nœuds de l'arbre tout entier (utile quand on ne connait
pas à-priori la taille des définitions étudiées) ; ou bien (ii) ne
retenir que les empreintes des sous-arbres ayant un nombre~$n$ de
nœuds (utile quand on ne s'intéresse qu'aux fonctions dont on connait
