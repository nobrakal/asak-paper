...
\am{La complexité n'est pas mon problème ici, il s'agit juste d'une technique "légale" pour identifier plus de codes (et surtout des codes pouvant être factorisés, quitte à prendre le plus rapide)}
...
Il reste maintenant à décider quelle fonction de hachage utiliser. Ne nous intéressant pas à des questions de sécurité, nous avons décidé d'utiliser
