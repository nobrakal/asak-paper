...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item Nous avons développé une librairie qui suit cette méthodologie.
		\item asak: \url{https://github.com/nobrakal/asak}
		\item Disponible sur OPAM et intégrée dans LearnOCaml.
		\item Qui produit des \emph{dendrogrammes} à partir d'un corpus.
	\end{itemize}
